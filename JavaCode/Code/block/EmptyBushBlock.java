...
import net.mcreator.mymodpack.procedures.BushTransformProcedure;
...
public class EmptyBushBlock extends MyModpackElements.ModElement {
	@ObjectHolder("mymodpack:emptybush")
	public static final Block block = null;
	public EmptyBushBlock(MyModpackElements instance) {
		super(instance, 42);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BushTransformProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
