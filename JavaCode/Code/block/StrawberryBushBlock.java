...
import net.mcreator.mymodpack.procedures.ReplaceBlockEventProcedure;
...
public class StrawberryBushBlock extends MyModpackElements.ModElement {
	@ObjectHolder("mymodpack:strawberrybush")
	public static final Block block = null;
	public StrawberryBushBlock(MyModpackElements instance) {
		super(instance, 43);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				ReplaceBlockEventProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
