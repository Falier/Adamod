...
import net.mcreator.mymodpack.gui.CraftingFOrgeGui;
...
public class CrraftingForgeBlockkBlock extends MyModpackElements.ModElement {
	@ObjectHolder("mymodpack:crraftingforgeblockk")
	public static final Block block = null;
	public CrraftingForgeBlockkBlock(MyModpackElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("crraftingforgeblockk");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Crrafting Forge Blockk");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new CraftingFOrgeGui.GuiContainerMod(id, inventory,
